...
class Keyboard:
    ...
    def printKeyInfo(self):
        """ Print raw positions of all keys """
        # for key in self.keys:
        #     print(key.x, ",", key.y, ",", key.width, ",", key.height)
        print(self.rows.blocks)
        print(self.columns.blocks)
...
class KLEPCBGenerator:
    ...
    def generate_schematic(self, args):
        ...
        with open(args.outname + '.sch', 'w', newline='\n') as out_file:
    ...
    def generate_layout(self, args):
        ...
        with open(args.outname + '.kicad_pcb', 'w', newline='\n') as out_file:
